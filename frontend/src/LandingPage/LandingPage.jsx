    ...
    <>
      ...
      <main className="main">
        <section className="main-section-one">
          ...
          <p className="section-one-article">
            Emisi Karbon yang dijual di marketplace ini diwakili dengan token,
            satu token sebanding dengan satu ton emisi karbon
          </p>
        </section>
      ...
      <footer className="footer">
        <section className="footer-section-one">
          ...
          <div className="last-footer-section">
            <p>
              Ada masalah? Silakan kontak kami <span>di sini</span>
            </p>
